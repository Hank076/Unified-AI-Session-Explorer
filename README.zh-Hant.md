# TraceLens：Claude 專案歷史瀏覽器

這是一個基於 **Tauri 2** 與 **Rust** 開發的高性能、隱私優先桌面應用程式，專為視覺化與探索本機 Claude 專案歷史而設計。

## 🚀 概覽

Claude 會將專案會話、記憶檔案與子代理日誌以 `.jsonl` 格式儲存在本地。**TraceLens** 提供了一個簡潔且專業的界面，讓你能瀏覽這些紀錄，並具備結構化時間軸、工具調用關聯以及會話元數據統計功能。

## 🔒 隱私至上

你的資料屬於你自己。**TraceLens** 秉持「純本地運作」的設計理念：
